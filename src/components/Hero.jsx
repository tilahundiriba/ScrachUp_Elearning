    ...
    <section className="pt-12 lg:pt-18 pb-20">
      <div className="container grid gap-14 lg:grid-cols-[1fr_0.9fr] lg:items-center">
        ...
        <div className="space-y-2.5 sm:text-center lg:text-left">
          ...
          <h1 className="text-4xl font-semibold leading-[1.1] md:text-5xl lg:text-6xl"> Professional and Lifelong learning comes here.</h1>
        ...
        <div className="relative mx-auto p-5">
          <div className="max-w-[370px] w-full shadow-img mx-auto 
          ...
          {/* Decorations */}
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="size-10 absolute top-20 left-0 -rotate-12"
          >
            <path
         ...
         <svg
          ...
          <p className="text-center"> <span className="font-bold">100k+
            </span> students <br /> learn daily</p>
          </div>
        </div>
      </div>
    </section>
